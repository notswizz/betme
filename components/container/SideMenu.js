...
export default function SideMenu({ isSideMenuOpen, onNewChat, onClose }) {
  ...
  return (
    <>
      ...
      <div
        ref={menuRef}
        className={`fixed left-0 top-0 h-full w-[min(85vw,320px)] bg-gradient-to-b from-gray-900 to-gray-950 
            ...
            <div className="flex items-center justify-between p-3">
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-blue-500 to-blue-600 
                  ...
                  <span className="text-base font-bold text-white">BB</span>
                </div>
                <span className="text-lg font-bold bg-gradient-to-r from-blue-100 to-blue-300 
